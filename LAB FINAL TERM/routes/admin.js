...
router.post('/products/add', isAdmin, async (req, res) => {
  try {
    ...
    // ✅ isOnSale: checkbox sends 'true' string when checked, undefined when unchecked
    const isOnSale = req.body.isOnSale === 'true';
